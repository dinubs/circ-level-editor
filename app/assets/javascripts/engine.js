var level = {
    ...
    "keys": [
        ...
        {"id": 3,"colour": "#C93232","solid": 0, "script": "die"},
        {"id": 4,"colour": "rgba(121, 220, 242, 0.4)", "friction": {"x": 0.9,"y": 0.9},"gravity": {"x": 0,"y": 0.1},"jump": 1,"fore": 1},
        {"id": 5,"colour": "#E373FA","solid": 1,"bounce": 1.1},
        {"id": 6,"colour": "#ffc61e","solid": 0, "script": "next_level"}
    ],
    ...
    "scripts": {
      "die": "this.reload_map()",
      "next_level": "this.reload_map(); document.querySelect('.game-modal').classList.add('active');"
    }
}
...
Clarity.prototype.set_player_position = function(x, y) {
    this.player.loc.x = this.current_map.tile_size * x;
    this.player.loc.y = this.current_map.tile_size * y;
}
